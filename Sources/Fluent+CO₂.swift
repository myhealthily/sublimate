...
public extension Array where Element: Model {
    func delete(on subl: CO₂) throws {
        try delete(on: subl.db).wait()
    }

    @discardableResult
    func create(on subl: CO₂) throws -> [Element] {
...
public extension Model {
    static func query(on subl: CO₂) -> SublimateQueryBuilder<Self> {
        return SublimateQueryBuilder(qb: query(on: subl.db))
    }

    static func find(_ id: IDValue?, on subl: CO₂) throws -> Self? {
        if let id = id {
    ...
    @discardableResult
    func create(on subl: CO₂) throws -> Self {
        try create(on: subl.db).wait()
        return self
    }

    @discardableResult
    func update(on subl: CO₂) throws -> Self {
        try update(on: subl.db).wait()
        return self
    }

    @discardableResult
    func save(on subl: CO₂) throws -> Self {
    ...
    static func findOrAbort(_ id: IDValue, on subl: CO₂, file: String = #file, line: UInt = #line) throws -> Self {
...
public extension ParentProperty {
    func query(on subl: CO₂) -> SublimateQueryBuilder<To> {
        .init(qb: query(on: subl.db))
    }

    func get(on subl: CO₂) throws -> To {
